...
<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/css/client/KS_CSS/Userlogin.css">
...
<section>
    ...
    <button onclick="location.href='${pageContext.servletContext.contextPath}/Admin/login'" id="FooterButton" >관리자 로그인</button>
    <div id="login">
        <div class="container">
