...
<aside>
	<nav>
		...
		<button class="btn btn-c btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" onclick="location.href='${pageContext.servletContext.contextPath}/site/CenterInfo'"
				data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">층별 구조도</button>
